...
{
$id = maxid("article_subcate","SubCateID",$db);

$db->query("insert into article_subcate set
SubCateID   = '$id',
...
CateIcon    = '".$db->real_escape_string($_POST['txtCateIcon'])."',
PubDate     = '".date("Y-m-d h:i:s a")."',
CateOrder   = '".$db->real_escape_string($_POST['txtCateOrder'])."'
");

notify("Sub Category Manager","Category Inserted Successfully",base_url()."subcategorymanager.php", FALSE,1000,0);
...
if($_SESSION['rand'] == $_POST['rand'])
{
$db->query("update article_subcate set
CateTitle   = '".$db->real_escape_string($_POST['txtCateTitle'])."',
CateID  = '".$db->real_escape_string($_POST['txtCateID'])."',
Status      = '".$db->real_escape_string($_POST['txtStatus'])."',
CateIcon    = '".$db->real_escape_string($_POST['txtCateIcon'])."',
...
CateOrder   = '".$db->real_escape_string($_POST['txtCateOrder'])."'
where
SubCateID       = '".$db->real_escape_string($_POST['txtSubCateID'])."'
");

notify("Sub Category Manager","Category Modified Successfully",base_url()."subcategorymanager.php", FALSE,1000,0);
...
if($_SESSION['rand'] == $_POST['rand'])
{
$db->query("delete from article_subcate where SubCateID = '".$_POST['SubCateID']."'");
notify("Sub Category Manager","Category Deleted Successfully",base_url()."subcategorymanager.php", FALSE,1000,0);
...
if($_SESSION['rand'] == $_POST['rand'])
{
$db->query("update article_subcate set Status = '1' where SubCateID = '".$_POST['SubCateID']."'");
notify("Sub Category Manager","Category Modified Successfully",base_url()."subcategorymanager.php", FALSE,1000,0);
...
if($_SESSION['rand'] == $_POST['rand'])
{
$db->query("update article_subcate set Status = '0' where SubCateID = '".$_POST['SubCateID']."'");
notify("Sub Category Manager","Category Modified Successfully",base_url()."subcategorymanager.php", FALSE,1000,0);
        ...
        <div class="box box-success">
            ...
            <div class="box-body">
                ...
                <table id="dataTable" class="table table-bordered table-hover">
                    ...
                    <tbody>
                        <?php
                        $getCate = $db->query("select * from article_subcate order by CateOrder asc");
                        while($setCate = $getCate->fetch_object())
                        {
                        ?>
                        <tr>
                            <td><span class="fa <?php echo $setCate->CateIcon ?>"></span> <?php echo $setCate->CateTitle ?></td>
                            <td><strong><?php echo getMainCate($setCate->CateID,$db) ?></strong></td>
                            ...
                            <td align="center"><form method="post" class="btn-tooltips">
                                <a class="btn btn-primary btn-xs edit-cate" id="<?php echo $setCate->SubCateID ?>" href="#" title="Edit"><span class="fa fa-pencil"></a>
                                <button title="Delete" class="btn btn-danger btn-xs delete" type="submit" id="btnDelete2" name="btnDelete2"  data-id="<?php echo $setCate->SubCateID;?>" data-button="btnDelete" data-class="btn btn-danger" data-input-name="SubCateID" data-target="#delete_modal" data-toggle="modal" data-url=""><span class="fa fa-trash"></span></button>
                                
                                <button title="Hide" class="btn btn-warning btn-xs hidecate" type="submit" id="btnHide2" name="btnHide2"  data-id="<?php echo $setCate->SubCateID;?>" data-button="btnHide" data-class="btn btn-warning" data-input-name="SubCateID" data-target="#hide_modal" data-toggle="modal" data-url=""><span class="fa fa-ban"></span></button>
                                
                                <button title="Show" class="btn btn-success btn-xs showcate" type="submit" id="btnShow2" name="btnShow2"  data-id="<?php echo $setCate->SubCateID;?>" data-button="btnShow" data-class="btn btn-success" data-input-name="SubCateID" data-target="#show_modal" data-toggle="modal" data-url=""><span class="fa fa-check"></span></button>
            ...
            <div class="box-body">
                <form class="form-horizontal" id="AllForm" method="post">
                    <div class="form-group">
                        <div class="col-sm-6">
                            <label class="control-label" for="txtCateTitle">Sub Category Title</label>
                            <input type="text" class="form-control" name="txtCateTitle" id="txtCateTitle">
                        </div>
                        <div class="col-sm-6">
                            <label class="control-label" for="txtCateID">Category </label>
                            <select class="form-control" name="txtCateID" id="txtCateID">
                                <option value=""></option>
                                <?php
                        ...
                        <div class="col-sm-6">
                            <label class="control-label" for="txtCateIcon">Category Icon </label>
                            <select name="txtCateIcon" id="txtCateIcon" class="form-control fa-select">
                                <option></option>
                    ...
                    <input type="hidden" value="" name="txtSubCateID">
                </form>
            </div>
            <!-- /.box-body -->
        </div>
...
data:'CateID='+cateid,
dataType : "json",
url:"<?php echo base_url() ?>api/subcategory.php",
